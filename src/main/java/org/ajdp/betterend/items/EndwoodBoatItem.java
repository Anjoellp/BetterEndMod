...
import org.ajdp.betterend.entity.EndwoodBoatEntity;
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, PlayerEntity playerIn, Hand handIn) {
		...
		if (raytraceresult.getType() == RayTraceResult.Type.MISS) {
			...
			if (raytraceresult.getType() == RayTraceResult.Type.BLOCK) {
				BoatEntity boatentity = new EndwoodBoatEntity(worldIn, flying, raytraceresult.getHitVec().x,
						raytraceresult.getHitVec().y, raytraceresult.getHitVec().z);
				boatentity.setBoatType(ModBoatTypes.ENDWOOD);
