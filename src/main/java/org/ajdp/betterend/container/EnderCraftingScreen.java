...
public class EnderCraftingScreen extends ContainerScreen<EnderWorkbenchContainer> {
	private static final ResourceLocation CRAFTING_TABLE_GUI_TEXTURES = BetterEndMod
			.location("textures/gui/container/ender_crafting_table.png");
	...
	public EnderCraftingScreen(EnderWorkbenchContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
...
//		this.addButton(new ImageButton(this.guiLeft + 5, this.height / 2 - 49, 20, 18, 0, 0, 19, RECIPE_BUTTON_TEXTURE,
//				(p_214076_1_) -> {
...
//				}));
	...
	public void render(int p_render_1_, int p_render_2_, float p_render_3_) {
		...
		// this.recipeBookGui.renderTooltip(this.guiLeft, this.guiTop, p_render_1_,
		// p_render_2_);
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
		...
		int k = (this.height - 166) / 2;
		this.blit(i, j, 0, k, this.xSize, ySize);
	}

	protected boolean isPointInRegion(int x, int y, int width, int height, double mouseX, double mouseY) {
		return (!this.widthTooNarrow || !this.recipeBookGui.isVisible())
				&& super.isPointInRegion(x, y, width, height, mouseX, mouseY);
	}
	...
	public boolean mouseClicked(double p_mouseClicked_1_, double p_mouseClicked_3_, int p_mouseClicked_5_) {
		if (this.recipeBookGui.mouseClicked(p_mouseClicked_1_, p_mouseClicked_3_, p_mouseClicked_5_)) {
			...
			return this.widthTooNarrow && this.recipeBookGui.isVisible() ? true
	...
	protected boolean hasClickedOutside(double mouseX, double mouseY, int guiLeftIn, int guiTopIn, int mouseButton) {
		...
		return this.recipeBookGui.func_195604_a(mouseX, mouseY, this.guiLeft, this.guiTop, this.xSize, this.ySize,
				mouseButton) && flag;
	}
