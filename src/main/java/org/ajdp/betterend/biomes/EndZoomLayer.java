...
public enum EndZoomLayer implements IAreaTransformer1 {
	INSTANCE;
	...
	public int func_215728_a(IExtendedNoiseRandom<?> p_215728_1_, IArea p_215728_2_, int p_215728_3_, int p_215728_4_) {
		...
		if (d8 < d9 && d8 < d10 && d8 < d11) {
			...
			return d10 < d8 && d10 < d9 && d10 < d11
					? p_215728_2_.getValue(this.func_215721_a(i1), this.func_215722_b(j1 + 4))
					: p_215728_2_.getValue(this.func_215721_a(i1 + 4), this.func_215722_b(j1 + 4)) & 255;
		}
	}
